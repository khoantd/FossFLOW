...
const locale: LocaleProps = {
  ...
  canvasHints: {
    zoomAndPanTitle: "Навигация по холсту",
    zoomAndPanBody: "Прокрутите для увеличения, перетащите в пустом месте для перемещения. Удерживайте Shift при перетаскивании узла, чтобы ограничить движение.",
    contextMenuTitle: "Контекстные действия",
    contextMenuBody: "Щелкните правой кнопкой мыши на узле, соединителе или пустом месте для действий, специфичных для контекста."
  }
};
