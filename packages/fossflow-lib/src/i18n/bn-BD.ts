...
const locale: LocaleProps = {
  ...
  canvasHints: {
    zoomAndPanTitle: "ক্যানভাস নেভিগেট করা",
    zoomAndPanBody: "জুম করতে স্ক্রোল করুন, প্যান করতে খালি জায়গায় টানুন। একটি নোড টানার সময় Shift ধরে রাখুন আন্দোলন সীমাবদ্ধ করতে।",
    contextMenuTitle: "কনটেক্সট অ্যাকশন",
    contextMenuBody: "কনটেক্সট-নির্দিষ্ট অ্যাকশনের জন্য একটি নোড, কানেক্টর বা খালি জায়গায় রাইট-ক্লিক করুন।"
  }
};
