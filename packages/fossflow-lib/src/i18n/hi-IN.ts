...
const locale: LocaleProps = {
  ...
  canvasHints: {
    zoomAndPanTitle: "कैनवास नेविगेट करना",
    zoomAndPanBody: "ज़ूम करने के लिए स्क्रॉल करें, पैन करने के लिए खाली जगह पर खींचें। एक नोड खींचते समय गति को सीमित करने के लिए Shift दबाए रखें।",
    contextMenuTitle: "संदर्भ क्रियाएं",
    contextMenuBody: "संदर्भ-विशिष्ट क्रियाओं के लिए एक नोड, कनेक्टर या खाली जगह पर राइट-क्लिक करें।"
  }
};
